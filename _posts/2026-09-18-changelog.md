...
- **Publish a Resource if you can edit it.** Publishing a Resource or Opus Doc now follows the same per-item edit permission as Courses and Modules. Anyone who can edit an item can publish it, without needing the Manage Library permission.
...
- **Catch Guest Feedback locations that aren't linked.** Guest Feedback now tells you when a connected integration has locations that aren't matched to your Locations in Opus and links straight to the mapping tab, and Data Sources shows how many of each integration's locations are linked.
